...
export default function Home() {
  return (
    <div className="bg-[#212121] flex flex-col items-center h-screen bg-[url('/background.png')] bg-cover bg-no-repeat bg-center bg-fixed ">
      ...
      <div className="flex flex-col items-center border-1 p-2 rounded-lg border-[#24E030] mt-10">
        <p className={`text-xl text-[#24E030] text-center`}> launching sooner than you expect</p>
      </div>
      <div className="flex flex-col items-center mt-20">
        <h1 className="text-6xl text-white">circl</h1>
        <p className="text-white w-3/6 text-center mt-2">Never let a crucial follow-up get buried in the endless scroll. Get reminders directly within your WhatsApp conversations.</p>
        <Image src='/chat.png' alt="chat"width={400} height={400} className="w-1/4 hover:scale-105 duration-200 mt-10" />
      </div>
